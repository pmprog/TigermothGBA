...
const TigermothDetail play_tigermoth_level1 = {
    180, 1,                 // Direction and Velocity
  { 120 << 8, -24 << 8, 532, 30,  1, },    // Head
  { 106 << 8, -24 << 8,   0,  0,  0, },    // Row 1 Left
  { 120 << 8, -24 << 8,   0,  0,  0, },    // Row 1 Centre
  { 134 << 8, -24 << 8,   0,  0,  0, },    // Row 1 Right
  { 106 << 8, -24 << 8,   0,  0,  0, },    // Row 2 Left
  { 120 << 8, -24 << 8, 580, 10,  0, },    // Row 2 Centre
...
const TigermothDetail play_tigermoth_level2 = {
    180, 1,                 // Direction and Velocity
  { 120 << 8, -24 << 8, 532, 35,  2, },    // Head
  { 106 << 8, -24 << 8,   0,  0,  0, },    // Row 1 Left
  { 120 << 8, -24 << 8,   0,  0,  0, },    // Row 1 Centre
  { 134 << 8, -24 << 8,   0,  0,  0, },    // Row 1 Right
  { 106 << 8, -24 << 8,   0,  0,  0, },    // Row 2 Left
  { 120 << 8, -24 << 8, 580, 15,  0, },    // Row 2 Centre
  { 134 << 8, -24 << 8,   0,  0,  0, },    // Row 2 Right
  { 106 << 8, -24 << 8,   0,  0,  0, },    // Row 3 Left
  { 120 << 8, -24 << 8,   0,  0,  0, },    // Row 3 Centre
  { 134 << 8, -24 << 8,   0,  0,  0, },    // Row 3 Right
...
const TigermothDetail play_tigermoth_level3 = {
  ...
  { 134 << 8, -24 << 8,   0,  0,  0, },    // Row 1 Right
  { 106 << 8, -24 << 8,   0,  0,  0, },    // Row 2 Left
  { 120 << 8, -24 << 8, 548, 20,  0, },    // Row 2 Centre
  { 134 << 8, -24 << 8,   0,  0,  0, },    // Row 2 Right
  { 106 << 8, -24 << 8,   0,  0,  0, },    // Row 3 Left
  { 120 << 8, -24 << 8,   0,  0,  0, },    // Row 3 Centre
  { 134 << 8, -24 << 8,   0,  0,  0, },    // Row 3 Right
  { 120 << 8, -30 << 8, 580, 20,  0, },    // Row 6 Centre
};
...
const TigermothDetail play_tigermoth_level4 = {
  ...
  { 120 << 8, -24 << 8,   0,  0,  0, },    // Row 3 Centre
  { 134 << 8, -24 << 8,   0,  0,  0, },    // Row 3 Right
  { 120 << 8, -30 << 8, 580, 30,  0, },    // Row 6 Centre
};

const TigermothDetail play_tigermoth_level5 = {
    180, 2,                 // Direction and Velocity
  { 120 << 8, -24 << 8, 532, 60,  2, },    // Head
  { 106 << 8, -24 << 8,   0,  0,  0, },    // Row 1 Left
  { 120 << 8, -24 << 8,   0,  0,  0, },    // Row 1 Centre
  { 134 << 8, -24 << 8,   0,  0,  0, },    // Row 1 Right
...
const TigermothDetail play_tigermoth_level7 = {
    180, 3,                 // Direction and Velocity
  { 120 << 8, -24 << 8, 532, 80,  3, },    // Head
...
const TigermothDetail play_tigermoth_level9 = {
    180, 3,                 // Direction and Velocity
  { 120 << 8, -24 << 8, 532,100,  8, },    // Head
  { 106 << 8, -24 << 8, 516, 40,  7, },    // Row 1 Left
  { 120 << 8, -24 << 8, 564, 60,  0, },    // Row 1 Centre
  { 134 << 8, -24 << 8, 516, 40,  6, },    // Row 1 Right
  { 106 << 8, -24 << 8,   0,  0,  0, },    // Row 2 Left
  { 120 << 8, -24 << 8, 548, 60,  0, },    // Row 2 Centre
  { 134 << 8, -24 << 8,   0,  0,  0, },    // Row 2 Right
  { 106 << 8, -24 << 8, 516, 40,  7, },    // Row 3 Left
  { 120 << 8, -24 << 8, 564, 60,  0, },    // Row 3 Centre
  { 134 << 8, -24 << 8, 516, 40,  6, },    // Row 3 Right
  { 120 << 8, -30 << 8, 580, 50,  2, },    // Row 6 Centre
};

const TigermothDetail play_tigermoth_level10 = {
    180, 3,                 // Direction and Velocity
  { 120 << 8, -24 << 8, 532,120,  2, },    // Head
  { 106 << 8, -24 << 8, 516, 50,  5, },    // Row 1 Left
  { 120 << 8, -24 << 8, 564, 70,  3, },    // Row 1 Centre
  { 134 << 8, -24 << 8, 516, 50,  4, },    // Row 1 Right
  { 106 << 8, -24 << 8,   0,  0,  0, },    // Row 2 Left
  { 120 << 8, -24 << 8, 548, 70,  0, },    // Row 2 Centre
  { 134 << 8, -24 << 8,   0,  0,  0, },    // Row 2 Right
  { 106 << 8, -24 << 8, 516, 50,  5, },    // Row 3 Left
  { 120 << 8, -24 << 8, 564, 70,  3, },    // Row 3 Centre
  { 134 << 8, -24 << 8, 516, 50,  4, },    // Row 3 Right
  { 120 << 8, -30 << 8, 580, 60, 10, },    // Row 6 Centre
};

const TigermothDetail play_tigermoth_level11 = {
    180, 3,                 // Direction and Velocity
  { 120 << 8, -24 << 8, 532,150,  3, },    // Head
  { 106 << 8, -24 << 8, 516, 60,  7, },    // Row 1 Left
  { 120 << 8, -24 << 8, 564, 90,  2, },    // Row 1 Centre
  { 134 << 8, -24 << 8, 516, 60,  6, },    // Row 1 Right
  { 106 << 8, -24 << 8,   0,  0,  0, },    // Row 2 Left
